            ...
            return (
                ...
                >
                    ...
                    <div style={{height: "50px", marginBottom: "20px"}}>
                        ...
                        <Tag color="red">{this.props.userDetail.userInfo.sex==null?'':this.props.userDetail.userInfo.sex+"生,"}总共发布宝贝{this.props.userDetail.publishClassCount}件</Tag>
                        <label>
                            在架{this.props.userDetail.publishGoodsCount}件，
                            活动中{this.props.userDetail.goodsActiveCount}件，
                            卖出{this.props.userDetail.userSellCount}件，
...
export default Form.create()(UserDetail);        //创建form实例
